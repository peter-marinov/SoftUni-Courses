...
from modules_exercise.canvas import *
from modules_exercise.helpers import clean_screen
from modules_exercise.buying_page import display_products
...
def logging():
    if check_login():
        ...
        frame.create_text(165, 200, text="Invalid username or password!", fill="red")
...
first_name_box = Entry(root, bd=1)
last_name_box = Entry(root, bd=1)
username_box = Entry(root, bd=1)
password_box = Entry(root, bd=1, show='*')
