from polymorphism_and_abstraction_exercise.formula_one_manager.formula_teams.mercedes_team import MercedesTeam
from polymorphism_and_abstraction_exercise.formula_one_manager.formula_teams.red_bull_team import RedBullTeam
