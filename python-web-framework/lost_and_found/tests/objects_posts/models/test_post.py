...
class PhoneTests(TestCase):
    ...
    def test_crete__when_title_has_1_more_than_valid_characters__expect_to_raise(self):
    ...
    def test_create__when_phone_starts_not_with_0__plus__expect_to_raise(self):
        invalid_data = {
